...
export default function StatsHubScreen() {
  ...
  const renderMyStats = () => {
    if (!myPlayer) {
      return (
        <View style={[styles.emptyCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <Text style={[styles.emptyTitle, { color: colors.textPrimary }]}>No Player Linked</Text>
          <Text style={[styles.emptyDesc, { color: colors.textMuted }]}>Link a player to your account to view your stats and rankings.</Text>
        </View>
      );
    }
    ...
    return (
      <>
        ...
        <TouchableOpacity
          style={[styles.identityRow, { backgroundColor: colors.surface, borderColor: colors.border }]}
        ...
        >
          {photoUri ? (
            <Image
              source={{ uri: photoUri }}
              style={[styles.identityAvatar, { backgroundColor: colors.surfaceLight }]}
              contentFit="cover"
              transition={200}
            />
          ) : (
            <View style={[styles.identityAvatar, styles.identityAvatarFallback, { backgroundColor: colors.surfaceLight }]}>
              <Text style={[styles.identityInitials, { color: colors.textSecondary }]}>
          ...
          <View style={styles.identityInfo}>
            ...
            <View style={styles.identityMeta}>
              {pos && <Text style={[styles.identityMetaText, { color: colors.textMuted }]}>{pos}</Text>}
              {pos && myPlayer.graduationYear && <View style={[styles.metaDot, { backgroundColor: colors.surfaceLight }]} />}
              {myPlayer.graduationYear && (
                <Text style={[styles.identityMetaText, { color: colors.textMuted }]}>Class of {myPlayer.graduationYear}</Text>
              )}
            </View>
          </View>
          ...
          <View style={styles.identityRight}>
            {cs && (
              <View style={[styles.gpBadge, { backgroundColor: colors.surfaceLight, borderColor: colors.border }]}>
                <Text style={[styles.gpBadgeText, { color: colors.textSecondary }]}>{cs.gamesPlayed} GP</Text>
              </View>
            )}
            <Text style={[styles.identityChevron, { color: colors.textMuted }]}>›</Text>
          </View>
        </TouchableOpacity>
        ...
        <View style={[styles.modeToggle, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          {([['avg', 'Per Game'], ['total', 'Season Totals']] as [StatsMode, string][]).map(([mode, label]) => (
            <TouchableOpacity
              key={mode}
              style={[styles.modeBtn, statsMode === mode && { backgroundColor: colors.navyLight }]}
              onPress={() => setStatsMode(mode)}
              activeOpacity={0.7}
            >
              <Text style={[styles.modeBtnText, { color: colors.textMuted }, statsMode === mode && { color: colors.textPrimary }]}>
                {label}
              </Text>
            </TouchableOpacity>
          ))}
        ...
        {cs ? (
          <View style={[styles.statsCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <View style={styles.statsCardTop}>
              <Text style={[styles.statsCardTitle, { color: colors.textMuted }]}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={[styles.statsCardLink, { color: colors.textMuted }]}>Game Log ›</Text>
              </TouchableOpacity>
            </View>
              ...
              {[
                ...
                <React.Fragment key={s.label}>
                  <View style={styles.mainStatItem}>
                    <Text style={[styles.mainStatValue, { color: colors.textPrimary }]}>{s.val}</Text>
                    <Text style={[styles.mainStatLabel, { color: colors.textMuted }]}>{s.label}</Text>
                  </View>
            ...
            <View style={[styles.cardDividerLine, { backgroundColor: colors.border }]} />
              ...
              {[
                ...
                <React.Fragment key={s.label}>
                  <View style={styles.secondaryStatItem}>
                    <Text style={[styles.secondaryStatValue, { color: colors.textSecondary }]}>{s.val}</Text>
                    <Text style={[styles.secondaryStatLabel, { color: colors.textMuted }]}>{s.label}</Text>
                  </View>
                  {i < arr.length - 1 && <View style={[styles.statDivider, { backgroundColor: colors.border }]} />}
                </React.Fragment>
              ))}
              ...
              {[
                ...
                <React.Fragment key={s.label}>
                  <View style={styles.shootingItem}>
                    <Text style={[styles.shootingValue, { color: colors.textSecondary }]}>{s.val}</Text>
                    <Text style={[styles.shootingLabel, { color: colors.textMuted }]}>{s.label}</Text>
                  </View>
                  {i < arr.length - 1 && <View style={[styles.statDivider, { backgroundColor: colors.border }]} />}
                </React.Fragment>
              ))}
          ...
          <View style={[styles.statsCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
            <Text style={[styles.statsCardTitle, { color: colors.textMuted }]}>SEASON STATS</Text>
        ...
        <View style={styles.rankingsSection}>
          <Text style={[styles.rankingsSectionTitle, { color: colors.textMuted }]}>MY RANKINGS</Text>
          <Text style={[styles.rankingsSectionSub, { color: colors.textMuted }]}>Your position in the EHA leaderboards</Text>
            ...
            {STAT_CATS.map((cat, idx) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.rankingRow,
                    !isLast && [styles.rankingRowBorder, { borderBottomColor: colors.border }],
                    isTop3   && { backgroundColor: colors.goldTint },
                  ]}
                  onPress={() => { setSegment('leaderboards'); setLbCategory(cat.key); }}
                  activeOpacity={0.7}
                >
                  <Text style={[styles.rankingLabel, { color: colors.textPrimary }]}>{cat.label}</Text>

                  <View style={styles.rankingRight}>
                    {rd ? (
                      <>
                        <Text style={[styles.rankingVal, { color: colors.textSecondary }, isTop3 && { color: colors.gold }]}>
                          {fmtStat(rd.value, cat.pct)}
                        </Text>
                        <View style={[
                          styles.rankBadge,
                          isTop3 ? { backgroundColor: RANK_COLORS[rd.rank - 1] } : { backgroundColor: colors.surfaceLight },
                        ]}>
                          <Text style={[styles.rankBadgeText, { color: colors.textSecondary }, isTop3 && { color: '#0F172A' }]}>
                            #{rd.rank}
                          </Text>
                        </View>
                      </>
                    ) : (
                      <Text style={[styles.rankingNone, { color: colors.textMuted }]}>Not ranked</Text>
                    )}
                    <Text style={[styles.rankChevron, { color: colors.textMuted }]}>›</Text>
                  </View>
                </TouchableOpacity>
              );
            })}
  ...
  const renderLeaderboards = () => (
    <>
        ...
        {STAT_CATS.map(cat => (
          <TouchableOpacity
            ...
            style={[
              ...
              lbCategory === cat.key && { backgroundColor: colors.red, borderColor: colors.red },
            ]}
          ...
          >
            <Text style={[
              ...
              lbCategory === cat.key && { color: colors.textPrimary },
            ]}>
              {cat.label}
            </Text>
          </TouchableOpacity>
      ...
      {currentLb.length === 0 ? (
        <View style={[styles.emptyCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          <Text style={[styles.emptyDesc, { color: colors.textMuted }]}>No leaderboard data available.</Text>
        </View>
      ) : (
        <View style={[styles.leaderList, { borderColor: colors.border }]}>
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  index % 2 === 1 && { backgroundColor: colors.alternateRow },
                  isMe            && { borderLeftWidth: 2, borderLeftColor: colors.gold },
                ]}
              ...
              >
                ...
                <View style={[
                  styles.rankBadge,
                  isTop3 ? { backgroundColor: RANK_COLORS[rank - 1] } : { backgroundColor: colors.surfaceLight },
                ]}>
                  <Text style={[styles.rankBadgeText, { color: colors.textSecondary }, isTop3 && { color: '#0F172A' }]}>
                    {rank}
                  </Text>
                ...
                <Image
                  ...
                  style={[styles.leaderAvatar, { backgroundColor: colors.surfaceLight }]}
                  contentFit="cover"
                  transition={200}
                />
                ...
                <View style={styles.leaderInfo}>
                  <Text style={[styles.leaderName, { color: colors.textPrimary }, isMe && { color: colors.gold }]} numberOfLines={1}>
                    {item.player.firstName} {item.player.lastName}
                    {isMe ? '  (You)' : ''}
                  </Text>
                  <Text style={[styles.leaderMeta, { color: colors.textMuted }]}>
                    {[
                ...
                <View style={styles.leaderStat}>
                  ...
                  <Text style={[styles.leaderStatLabel, { color: colors.textMuted }]}>{currentLbLabel.toUpperCase()}</Text>
                </View>
              </TouchableOpacity>
            );
          })}
    ...
    return (
      <View style={styles.standingsContainer}>
        {divisions.map(({ division, entries }) => {
          ...
          return (
            <View key={division} style={[styles.divisionCard, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              {/* Accordion header */}
              <TouchableOpacity
              ...
              >
                <View style={styles.divisionLeft}>
                  <View style={[styles.divisionDot, { backgroundColor: colors.red }]} />
                  <Text style={[styles.divisionName, { color: colors.textPrimary }]}>{division}</Text>
                </View>
                <View style={styles.divisionRight}>
                  <Text style={[styles.divisionCount, { color: colors.textMuted }]}>{entries.length} teams</Text>
                  <Text style={[styles.divisionChevron, { color: colors.textMuted }, expanded && styles.divisionChevronOpen]}>›</Text>
                </View>
              </TouchableOpacity>

              {/* Team table */}
              {expanded && (
                <View style={[styles.teamTable, { borderTopColor: colors.border }]}>
                  {/* Column headers */}
                  <View style={[styles.tableHeader, { backgroundColor: colors.navySurface }]}>
                    <Text style={[styles.tableHeaderText, styles.teamCol, { color: colors.textMuted }]}>TEAM</Text>
                    <Text style={[styles.tableHeaderText, styles.numCol, { color: colors.textMuted }]}>GP</Text>
                    <Text style={[styles.tableHeaderText, styles.numCol, { color: colors.textMuted }]}>W</Text>
                    <Text style={[styles.tableHeaderText, styles.numCol, { color: colors.textMuted }]}>L</Text>
                    <Text style={[styles.tableHeaderText, styles.numCol, { color: colors.textMuted }]}>DIFF</Text>
                  </View>
                    ...
                    return (
                      <View
                        ...
                        style={[
                          styles.tableRow,
                          { backgroundColor: colors.surface },
                          idx % 2 === 1 && { backgroundColor: colors.alternateRow },
                        ]}
                      >
                        <View style={[styles.tableTeamCell, styles.teamCol]}>
                          {entry.teamLogo ? (
                            <Image
                              ...
                              style={[styles.teamLogo, { backgroundColor: colors.surfaceLight }]}
                              contentFit="cover"
                            />
                          ) : (
                            <View style={[styles.teamLogoFallback, { backgroundColor: colors.surfaceLight }]}>
                              <Text style={[styles.teamLogoInitial, { color: colors.textSecondary }]}>
                                {(entry.teamName[0] ?? '').toUpperCase()}
                              </Text>
                            </View>
                          )}
                          <Text style={[styles.tableTeamName, { color: colors.textPrimary }]} numberOfLines={1}>
                            {entry.teamName}
                          </Text>
                        </View>
                        <Text style={[styles.tableNum, styles.numCol, { color: colors.textSecondary }]}>{gp}</Text>
                        ...
                        <Text style={[
                          ...
                          styles.numCol,
                          { color: colors.textSecondary },
                          diff > 0 ? { color: colors.success } : diff < 0 ? { color: colors.red } : {},
                        ]}>
          ...
          <View style={[styles.headerInner, { paddingTop: Platform.OS === 'ios' ? 50 : 30, backgroundColor: colors.headerOverlay }]}>
            ...
            <View style={styles.headerTitleRow}>
              <Image
                ...
                contentFit="contain"
              />
              <Text style={[styles.headerName, { color: colors.textPrimary }]}>Stats</Text>
            </View>

            {/* Segmented control */}
            <View style={[styles.segmentedControl, { backgroundColor: colors.inputOverlay }]}>
              {([
                ['mystats',      'My Stats'    ],
                ...
                <TouchableOpacity
                  key={key}
                  style={[styles.segBtn, segment === key && { backgroundColor: colors.red }]}
                  onPress={() => setSegment(key)}
                  activeOpacity={0.7}
                >
                  <Text style={[styles.segBtnText, { color: colors.textMuted }, segment === key && { color: colors.textPrimary }]}>
                    {label}
                  </Text>
                </TouchableOpacity>
              ))}
