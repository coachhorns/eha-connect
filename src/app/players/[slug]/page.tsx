        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-shrink-0">
              <div className="relative w-48 h-48 lg:w-64 lg:h-64 rounded-2xl overflow-hidden bg-[#1A1A2E] mx-auto lg:mx-0">
                {player.profilePhoto ? (
                  <Image
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-[#252540] text-5xl font-bold text-gray-500">
              ...
              <div className="mt-4 flex items-center justify-center lg:justify-start gap-3">
                {player.twitterHandle && (
                  <a
                    ...
                    className="p-2 bg-[#252540] rounded-lg text-gray-400 hover:text-white hover:bg-[#1DA1F2]/20 transition-colors"
                  >
                ...
                {player.instagramHandle && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 bg-[#252540] rounded-lg text-gray-400 hover:text-white hover:bg-[#E4405F]/20 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            {careerStats && (
              <Card className="lg:w-72 flex-shrink-0">
                ...
                <div className="px-4 pb-4 pt-2 border-t border-[#252540] grid grid-cols-3 gap-2 text-center text-sm">
                  <div>
              ...
              <div className="flex flex-wrap gap-3">
                {player.achievements.map((achievement: any) => {
                  ...
                  return (
                    <div
                      key={achievement.id}
                      className="flex items-center gap-2 px-4 py-2 bg-[#252540] rounded-lg"
                    >
