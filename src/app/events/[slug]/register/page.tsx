      ...
      <div className="min-h-screen">
        <div className="max-w-2xl mx-auto px-4 py-16 text-center">
          <div className="bg-page-bg border border-border-default rounded-sm p-8">
            ...
            <h1 className="text-2xl font-heading font-bold text-text-primary mb-2">Event Not Found</h1>
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Event Info Sidebar */}
          <div>
            <div className="bg-page-bg border border-border-default rounded-sm p-6 sticky top-24">
