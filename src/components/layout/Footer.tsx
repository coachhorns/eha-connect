          ...
          <div className="col-span-1">
            ...
            <div className="mt-4 flex gap-4">
              <a
                ...
                className="text-gray-500 hover:text-eha-red transition-colors"
              >
            ...
            <ul className="space-y-2">
              {footerLinks.players.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-500 hover:text-eha-red transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
