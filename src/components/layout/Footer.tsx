        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="mt-4 text-text-muted text-sm">
              The official player profile and stats platform for Elite Hoops Association events.
            </p>
            <div className="mt-4 flex gap-4">
              <a
                ...
                className="text-text-muted hover:text-eha-red transition-colors"
              >
          ...
          {/* Players */}
          <div>
            <h3 className="text-text-primary font-semibold mb-4">Players</h3>
            <ul className="space-y-2">
              {footerLinks.players.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-text-muted hover:text-eha-red transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          {/* Events */}
          <div>
            <h3 className="text-text-primary font-semibold mb-4">Events</h3>
            <ul className="space-y-2">
